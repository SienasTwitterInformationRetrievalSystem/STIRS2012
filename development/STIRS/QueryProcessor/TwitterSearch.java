...
public class TwitterSearch {
	...
	public static void main(String[] args) throws Exception {
		final String USAGE = "Usage:\tjava TwitterSearch -index indexDir [-field f] [-repeat n] [-queries file] [-query string] [-raw] [-paging hitsPerPage]\n";
